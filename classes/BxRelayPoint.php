...
class BxRelayPoint
{
    ...
    public function add()
    {
        ...
        $relaypoint_detail = ['id_carrier' => $this->id_db_carrier, 'id_remote_relay' => $this->id_remote_relay, 'id_remote_carrier' => $this->id_remote_carrier, 'description' => $this->description, 'street' => $this->street, 'number' => $this->number, 'floor' => $this->floor, 'department' => $this->department, 'postal_code' => $this->postal_code, 'locality' => $this->locality, 'latitude' => $this->latitude, 'longitude' => $this->longitude];
