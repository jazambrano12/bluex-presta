...
class BxAddress
{
    ...
    protected $palabraClavesPrevias = ['de', 'calle', 'pje', 'pje.', 'pasaje', 'prov', 'prov.', 'provincial', 'interprovincial', 'diag', 'diag.', 'diagonal', 'ruta', 'av', 'av.', 'avenida', 'peat', 'peat.', 'peatonal', 'entre', 'y', 'regimiento', 'esquina', 'esq', 'esq.'];
    protected $palabraClavesPosteriores = ['de', 'km', 'y'];
