...
class BlueExpressActionOrderStatusPostUpdateController
{
    public function __construct($module, $file, $path)
    {
        ...
        $this->_path = $path;
        $this->palabraClavesPrevias = ['de', 'calle', 'pje', 'pje.', 'pasaje', 'prov', 'prov.', 'provincial', 'interprovincial', 'diag', 'diag.', 'diagonal', 'ruta', 'av', 'av.', 'avenida', 'peat', 'peat.', 'peatonal', 'entre', 'y', 'regimiento', 'esquina', 'esq', 'esq.'];
        $this->palabraClavesPosteriores = ['de', 'km', 'y'];
